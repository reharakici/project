            ...
            <?php
				if($_POST){
					...
					if($resim!=""){
						...
						$kategori_resim_yol=$kategori_link."-".rand(1,1000000).".jpg"; 
						$image->save("../assets/media/kategori_resim/".$kategori_resim_yol);
					}else{
						$kategori_resim_yol="../assets/media/kategori_resim/1.jpg";
					}
					if(!$kategori_adi){
						...
						if(mysql_affected_rows()){
							echo '<h4 class="alert_error"><strong>'.ss($kategori_adi).' kategorisi daha önceden eklenmiş. Başka Bir Tane Deneyin!!!</h4>';	
						}else{
							$insert=query("insert into kategoriler SET
							kategori_ad='$kategori_adi',
							kategori_link='$kategori_link',
							kategori_keyw='$kategori_keyw',
							kategori_resim='$kategori_resim_yol'");
							
							if($insert){
								echo '<h4 class="alert_success">Yeni Kategori Başarıyla Eklendi</h4>';
											...
											<form action="" method="post" id="form_sample_1" class="form-horizontal form-row-seperated" enctype="multipart/form-data">
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" name="kategori_adi" required data-required="1" class="form-control"/>
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" name="kategori_keyw" class="form-control"/>
